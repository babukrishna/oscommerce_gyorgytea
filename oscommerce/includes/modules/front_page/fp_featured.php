      ...
      if ($PHP_SELF == 'index.php' && $cPath == '') {
        ...
        for ($id = 1; $id < $this->count; $id++) {
          ...
          if ($products_id > 0) {
            ...
            $featured__content .= '        <td width="' . $width . '%" align="center" valign="top">' . PHP_EOL;
            ...
            $featured__content .= '          <br /><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_products['products_id']) . '">' . $featured_products['products_name'] . '</a><br />' . PHP_EOL;
            $featured__content .= '          ' . $products_price . PHP_EOL;
            $featured__content .= '        </td>' . PHP_EOL;
